...
class CustomDropdown extends StatefulWidget {
  ...
  final List<String> items; // Dropdown'da gösterilecek öğeler
  ...
  const CustomDropdown({
    ...
    required this.items, // Dropdown öğelerini zorunlu yapıyoruz
    required this.hintText, // Hint text'i zorunlu yapıyoruz
  });
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              hint: Text(
                widget.hintText, // Dinamik ipucu metni
              ...
              items: widget.items.map((String value) { // Dinamik öğeler
